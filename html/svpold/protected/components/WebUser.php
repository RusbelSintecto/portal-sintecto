...
// Redirect the page to Login
    ...
    function isInManagerList($user){
        $_manger_users = array(
            'lzubieta@sintecto.com','admin@svision.co', 'ngonzalez@sintecto.com','jcocoma@sintecto.com','pvargas@sintecto.com', 'wlugo@svision.co', 'wlugo@sintecto.com', 'fperez@sintecto.com','nhenao@sintecto.com','hgutierrez@sintecto.com', 'mflorez@sintecto.com', 'srodriguez@sintecto.com', 'nbarrera@sintecto.com', 'acastellanos@sintecto.com', 'ygonzalez@sintecto.com', 'jsantana@sintecto.com','ilara@sintecto.com','jcuellar@sintecto.com', 'mpaez@sintecto.com', 'jmontero@sintecto.com','mguzman@sintecto.com', 'larboleda@sintecto.com');
        return in_array($user, $_manger_users);
    }
    
    function getIsManager($enforced = false, $log = false) {
        return ($this->getIsSuperAdmin($enforced, $log) && $this->isInManagerList($this->name));
    }
    ...
    function getIsIt($enforced = false, $log = false) {
        return ($this->getIsSuperAdmin($enforced, $log) && $this->isItList($this->name));
    }
    //Fin funciones

    function getIsReportManager($enforced = false, $log = false) {
        $users = array(
            'lzubieta@sintecto.com', 'admin@svision.co','ngonzalez@sintecto.com','sduarte@svision.co','jcocoma@sintecto.com','pvargas@sintecto.com','nhenao@sintecto.com','hgutierrez@sintecto.com', 'mpaez@sintecto.com');
    ...
    function isQualityDateList($user){
        $_manger_users = array('acastellanos@sintecto.com','jsantana@sintecto.com','wlugo@svision.co', 'wlugo@sintecto.com', 'nhenao@sintecto.com','jcocoma@sintecto.com','ngonzalez@sintecto.com','ygonzalez@sintecto.com','ilara@sintecto.com','nbarrera@sintecto.com');
        return in_array($user, $_manger_users);
    }
    function getIsQualityDate($enforced = false, $log = false) {
        return ($this->getIsSuperAdmin($enforced, $log) && $this->isQualityDateList($this->name));
    }
    //Fin fuinciones
    ...
    function isRequestsSAC($user){
        ...
        $_manger_users = array(
            'jcocoma@sintecto.com', 'wlugo@svision.co','wlugo@sintecto.com','acastellanos@sintecto.com', 'nbarrera@sintecto.com', 'ygonzalez@sintecto.com', 'dmoreno@sintecto.com', 'ilara@sintecto.com', 'jsantana@sintecto.com', 'oslodovan@sintecto.com', 'jcuellar@sintecto.com', 'nhenao@sintecto.com','ngonzalez@sintecto.com', 'sromero@sintecto.com', 'dduarte@sintecto.com', 'mpaez@sintecto.com', 'ediaz@sintecto.com','lhenao@sintecto.com', 'fvargas@sintecto.com', 'pvargas@sintecto.com');
        return in_array($user, $_manger_users);
    }
    function getIsRequestsSAC($enforced = false, $log = false) {
        return ($this->getIsSuperAdmin($enforced, $log) && $this->isRequestsSAC($this->name));
    }
    //Fin funciones
    ...
    $_manger_users = array(
        'jcocoma@sintecto.com','nhenao@sintecto.com','ngonzalez@sintecto.com','wlugo@svision.co','wlugo@sintecto.com', 'mgomez@sintecto.com','acastellanos@sintecto.com','jsantana@sintecto.com','ilara@sintecto.com', 'ygonzalez@sintecto.com', 'mquintero@sintecto.com', 'nbarrera@sintecto.com','mflorez@sintecto.com','jtabarez@sintecto.com');
    return in_array($user, $_manger_users);
    }
    function getIsResultOperation($enforced = false, $log = false) {
        return ($this->getIsSuperAdmin($enforced, $log) && $this->isResultOperation($this->name));
    }
    //Fin funciones
    ...
    function getIsRecoverStudy($enforced = false, $log = false) {
        return ($this->getIsSuperAdmin($enforced, $log) && $this->isRecoverStudy($this->name));
    }
    //Fin funciones
    ...
    function isSacList($user){
        $_manger_users = array('oslodovan@sintecto.com', 'dduarte@sintecto.com', 'mpaez@sintecto.com', 'jcuellar@sintecto.com', 'ediaz@sintecto.com');
        return in_array($user, $_manger_users);
    }
    function getIsSac($enforced = false, $log = false) {
        return ($this->getIsSuperAdmin($enforced, $log) && $this->isSacList($this->name));
    }
    //Fin funciones
    ...
    function isAgreements($user){
        $_manger_users = array(
            'jcocoma@sintecto.com', 'nhenao@sintecto.com', 'ngonzalez@sintecto.com','jcuellar@sintecto.com');
        return in_array($user, $_manger_users);
        }
        function getIsAgreements($enforced = false, $log = false) {
            return ($this->getIsSuperAdmin($enforced, $log) && $this->isAgreements($this->name));
        }
    //Fin funciones
...
// Load user model.
    ...
    public function sendMailInBackground($subject, $body, $to, $cc = null, $bcc = null, $filename=null) {
