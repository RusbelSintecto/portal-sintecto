...
class ETinyMce extends CInputWidget {
     ...
     * @var array
     */
    private $validEditorTemplates = array('simple', 'basic', 'pdfReport',  'full');
    ...
    protected function makeBasicEditor($url = '') {
        ...
        $options['theme_advanced_toolbar_align'] = 'left';
        $options['theme_advanced_path_location'] = 'bottom';
        $options['theme_advanced_buttons1'] = "save"
                . ",newdocument"
                . ",print"
                . ",|"
                . ",cut"
        ...
        // . ",help"
        ;
        $options['theme_advanced_buttons2'] = "{$sc}formatselect"
                . ",fontselect"
                . ",fontsizeselect"
                . ",|"
                . ",forecolor"
...
//                . "{$c1}"
        ...
        $options['theme_advanced_buttons3'] = "justifyleft"
                . ",justifycenter"
                . ",justifyright"
                . ",justifyfull"
                . ",|"
...
//                . ",anchor"
                ...
                . ",inserttime"
        ;
        $options['theme_advanced_buttons4'] = "{$c2}tablecontrols"
//                . ",|"
//                . ",insertlayer"
//                . ",moveforward"
//                . ",movebackward"
...
//                . ",template"
    ...
    protected function makePdfReportEditor($url = '') {
        $options = array();
...
//                . ",template"
        ...
        $options['theme_advanced_resizing'] = true;
        $options['spellchecker_languages'] = '+English=en,Danish=da,Dutch=nl,Finnish=fi,French=fr,German=de,Italian=it,Polish=pl,Portuguese=pt,Spanish=es,Swedish=sv';
//        $options['plugins']='inlinepopups';
//        $options['setup']="function(ed) {
//        ed.addButton('mybutton', {
//            title : 'My button',
//            image : '/css/example.gif',
//            onclick : function() {
//                ed.focus();
        ...
        if ($this->editorTemplate !== '') {
            switch ($this->editorTemplate) {
                ...
                case 'basic':
                    ...
                    break;
                case 'pdfReport':
                    $template = $this->makePdfReportEditor($url);
                    break;                
                case 'full':
