...
class CustomerProduct extends CActiveRecord {
    ...
    static public $optionListsFases = array (
        'Incremento IPC (13,12%)' => 'Incremento IPC (13,12%)',
        'Incremento SMLV (16%)' => 'Incremento SMLV (16%)',
        'Incremento 50% IPC' => 'Incremento 50% IPC',
        'Incremento 3,5% IPC' => 'Incremento 3,5% IPC',
        'Incremento 25%' => 'Incremento 25%',
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, customerId, name, maxDays, maxInternalDays, created, modified, isActive, '
                ...
                . 'expirationInterval,comments,attachmentFileId, preliminary, costVisitId, listFase1, listFase2, listFase3, dateFase1, dateFase2, dateFase3, hourExpress, isStandard, incremental, attachmentFileId2, isTusDatos, isWC, isSico, isRamaUnif, isMediosAbrt, isJurad', 'safe', 'on' => 'search'),
        );
    }
