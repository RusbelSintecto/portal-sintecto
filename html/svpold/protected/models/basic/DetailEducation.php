...
class DetailEducation extends SVPActiveRecord {
  ...
  public function afterSave() {
    ...
    $EducationalInstitutionList= EducationalInstitution::model()->findByAttributes(['name'=>$this->institution]);
    if(!$EducationalInstitutionList){
      $InstitutionList = new EducationalInstitution();
      $InstitutionList->name = $this->institution;
      $InstitutionList->phone=$this->tel;
      $InstitutionList->city=$this->city;
      $InstitutionList->country=$this->country;
      $InstitutionList->email=$this->email;
      $InstitutionList->contact=$this->contact;
      $InstitutionList->dateCreated=new CDbExpression('NOW()');
      $InstitutionList->save();
    }else{
      $EducationalInstitutionList->phone=$this->tel;
      $EducationalInstitutionList->city=$this->city;
      $EducationalInstitutionList->country=$this->country;
      $EducationalInstitutionList->email=$this->email;
      $EducationalInstitutionList->contact=$this->contact;
      $EducationalInstitutionList->dateCreated=new CDbExpression('NOW()');
      $EducationalInstitutionList->save();
    }
