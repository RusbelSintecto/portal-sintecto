...
class DetailJob extends SVPActiveRecord {
  ...
  public function afterSave() {
    ...
    $JobcompanyList= JobCompany::model()->findByAttributes(['name'=>$this->company]);
      if(!$JobcompanyList){
        $Jobcompany = new JobCompany();
        $Jobcompany->name = $this->company;
        $Jobcompany->phone=$this->tel;
        $Jobcompany->city=$this->city;
        $Jobcompany->country=$this->country;
        $Jobcompany->email=$this->email;
        $Jobcompany->contact=$this->nameOfContact;
        $Jobcompany->dateCreated=new CDbExpression('NOW()');
        $Jobcompany->save();
      }else{
        $JobcompanyList->phone=$this->tel;
        $JobcompanyList->city=$this->city;
        $JobcompanyList->country=$this->country;
        $JobcompanyList->email=$this->email;
        $JobcompanyList->contact=$this->nameOfContact;
        $JobcompanyList->dateCreated=new CDbExpression('NOW()');
        $JobcompanyList->save();
      }
