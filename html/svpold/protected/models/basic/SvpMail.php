...
class SvpMail {
    ...
    static public function sendMail($subject, $body, $to, $cc = null, $bcc = null, $files = null) {
        $ans = false;
        ...
        try {
            ...
            $message = array(
                ...
                'subject' => $subject,
                'from_email' => 'notificacion@sintecto.com',
                'from_name' => 'No Responder',
                'to' => $to_array,
                'headers' => array('Reply-To' => 'notificacion@sintecto.com'),
                'important' => false,
                'track_opens' => null,
                'track_clicks' => null,
                'auto_text' => null,
