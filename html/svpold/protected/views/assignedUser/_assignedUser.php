...
//            }
    ...
    <td>
        <?php if (!$assignedUser->isNewRecord): ?>
            <?php if (!$assignedUser->backgroundCheck->isApproved && !empty($assignedUser->finishedAt)  && Yii::app()->user->isAdmin): ?>
    ...
    <td>
        <?php if (!$assignedUser->isNewRecord && $assignedUser->backgroundCheck->canUpdate && Yii::app()->user->isAdmin): ?>
