...
<h1>Crear un Multiples Estudios de Seguridad</h1>
...
<div class="form wide ProcessTab">
    ...
    $form = $this->beginWidget('CActiveForm', array(
        ...
        'action' => array('/backgroundCheck/createMultiple'),
            ...
            <?php if ($model->isNewRecord): ?>
                ...
                echo $form->dropDownList(
                    ...
                    'ajax' => array(
                        ...
                        'url' => CController::createUrl('/customer/dynamicCustomerProducts', array('companySurvey' => 0)),
                        'success' => '  
