...
<h1>Recuperación de archivos de un cliente</h1>
...
<div class="form wide">
    ...
    <div class="row">
        <?php
        echo $form->labelEx($model, 'Mayor A'); ?>
        <?php
        $this->widget('zii.widgets.jui.CJuiDatePicker', array(
            'name' => 'BackgroundCheck[created]',
            'value' => $model->created,
            // additional javascript options for the date picker plugin
            'options' => array(
                'showAnim' => 'fold',
    ...
    <div class="row buttons">
        <?php echo CHtml::submitButton('Recuperar', array('name' => 'recover')); ?>
    </div>
