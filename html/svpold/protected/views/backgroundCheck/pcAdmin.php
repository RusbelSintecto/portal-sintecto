...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        'responsible' => array(
            ...
            'filter' => (Yii::app()->user->isAdmin ? CHtml::activeDropDownList($model, 'responsibleUserId',
                            //
        ...
        array(
            ...
            'buttons' => array(
                ...
                'update' => array(
                    'visible' => (Yii::app()->user->isSuperAdmin || Yii::app()->user->IsUser || Yii::app()->user->isAdmin ? 'true' : '!$data->reportAvailable'),
                )
            )
        ),
    ),
