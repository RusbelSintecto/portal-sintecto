<tr>
    ...
    <td style="width: 150px;">
        <?php if ($event->isNewRecord || !$event->informedToCustomer): ?>
            ...
            echo CHtml::textArea('events' .
                ...
                'rows' => 2,
                'cols' => 30,
                'disabled' => (!$event->isNewRecord && $event->informedToCustomer && !Yii::app()->user->isAdmin ),
            ));
            ?>
        <?php else: ?>
    ...
    <td>
        ...
        <?php else : ?>
            <?php if (!$event->isNewRecord && Yii::app()->user->isAdmin): ?>
                <?php
        ...
        <?php if (!$event->isNewRecord && $backgroundCheck->canUpdate && (!$event->informedToCustomer || Yii::app()->user->isAdmin )): ?>
            <?php
...
<tr>
        <?php if (!$event->isNewRecord && $backgroundCheck->canUpdate && ($event->reportSACDate!=null || $event->reportSACDate!="") && (!$event->informedToCustomer || Yii::app()->user->isAdmin)): ?>
            <td>
