...
/* @var $this QualityPorcController */
...
<h1>Resultados Funcionarios Operaciones</h1>
...
<fieldset>
    <html>
        ...
        <body>
            <form method="POST" action="/qualityPorc/update" class="">
                <div style="padding-top: 2px;" class="information" style="display:none;">
                    <div class="card">
                        <div class="card-body">
                            <label><b>PORCENTAJES DE CALIDAD</b></label> 
                            <div class="row">
                                <div class="col-lg-2" style="padding-left: 15px;">
                                    <center><label><b>Secciónes</b></label></center>
                                    <input type="text" name="seccion" id="seccion" class="form-control" value="<?php echo $valueSection; ?>">
                                </div>
                                <div class="col-lg-2" style="padding-left: 23px;">
                                    <center><label><b>PQR</b></label></center>
                                    <input type="text" name="pqr" id="pqr" class="form-control" value="<?php echo $valuePQR; ?>">
                                </div>
                                <div class="col-lg-2" style="padding-left: 26px;">
                                    <center><label><b>PNC</b></label></center>
                                    <input type="text" name="pnc" id="pnc" class="form-control" value="<?php echo $valuePNC; ?>">
                                </div>
            ...
            <form method="POST" action="/qualityPorc/resultoperations" class="">
                <div style="padding-top: 2px;" class="information" style="display:none;">
                    <div class="card">
                        <div class="card-body">
                            <label><center><b>Periodo y Funcionario</b></center></label> 
                            <div class="row">
                                ...
                                <div class="col-lg-2" style="padding-left: 30px;">
                                    <select class="form-control-sel" id="idUser" name="idUser">
                                        <option value="<?= $idUser ?>"><?= $nameUser ?></option>
                                        <?php
                                        $query =User::model()->findAll(array('order' => 'isActive desc,firstName'));
                                        foreach($query as $valores) {
                                            echo '<option value="'.$valores['id'].'">'.$valores['username'].'</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                ...
                <div class="card" >
                    <div class="card-body">
                        <div class="row g-2">  
                            ...
                            <div class="col-lg-1" style="padding-left: 20px; padding-top: 40px;">
                                <?php
                                    echo CHtml::button('EXPORT FUNCIONARIO', array(
                                        'id' => 'export-button',
                                        'class' => 'btn btn-primary btn-sm',
                                        'onClick' => "window.open('" . Yii::app()->controller->createUrl('/qualityPorc/exportForUser', array(
                                                '_export' => true,
                                                'from' => $Desde,
                                                'until' => $Hasta,   
                                                'idUser'=>$idUser,
            ...
            <div class="card">
                        <div class="card-body">
                            <label><center><b>Export Generales</b></center></label> 
                            <div class="row">
                                <div class="col-lg-1" style="padding-left: 10px;">
                                    <?php
                                        echo CHtml::button('PRODUCTIVIDAD Y OPORTUNIDAD', array(
                                            'id' => 'export-button',
                                            'class' => 'btn btn-primary btn-sm',
                                            'onClick' => "window.open('" . Yii::app()->controller->createUrl('/qualityPorc/exportproductopport', array(
                                                    '_export' => true,
                                                    'from' => $Desde,
                                                    'until' => $Hasta,    
                                                )) . "','_blank');"
                                ...
                                <div class="col-lg-1" style="padding-left: 140px;">
                                    <?php
                                        echo CHtml::button('FUERA DE TIEMPO', array(
                                            'id' => 'export-button',
                                            'class' => 'btn btn-primary btn-sm',
                                            'onClick' => "window.open('" . Yii::app()->controller->createUrl('/qualityPorc/exportoffTime', array(
                                                    '_export' => true,
                                                    'from' => $Desde,
                                                    'until' => $Hasta,   
                                                )) . "','_blank');"
                                ...
                                <div class="col-lg-1" style="padding-left: 30px;">
                                    <?php
                                        echo CHtml::button('CALIDAD', array(
                                            'id' => 'export-button',
                                            'class' => 'btn btn-primary btn-sm',
                                            'onClick' => "window.open('" . Yii::app()->controller->createUrl('/qualityPorc/exportQuality', array(
                                                    '_export' => true,
                                                    'from' => $Desde,
                                                    'until' => $Hasta,   
                                                )) . "','_blank');"
                                ...
                                <div class="col-lg-1" style="padding-left: 10px;">
                                    <?php
                                        echo CHtml::button('GESTIÓN DE OPERACIONES', array(
                                            'id' => 'export-button',
                                            'class' => 'btn btn-primary btn-sm',
                                            'onClick' => "window.open('" . Yii::app()->controller->createUrl('/qualityPorc/exportOperations', array(
                                                    '_export' => true,
                                                    'from' => $Desde,
                                                    'until' => $Hasta,   
                                                )) . "','_blank');"
                                ...
                                <div class="col-lg-1" style="padding-left: 370px;">
                                    <?php
                                        echo CHtml::button('EXPORT PROCESOS FINALIZADOS', array(
                                            'id' => 'export-button',
                                            'class' => 'btn btn-primary btn-sm',
                                            'onClick' => "window.open('" . Yii::app()->controller->createUrl('/qualityPorc/exportFinishProccess', array(
                                                    '_export' => true,
                                                    'from' => $Desde,
                                                    'until' => $Hasta,   
                                                )) . "','_blank');"
...
$(document).on('click', '.secc_resultQualitySection', function () {
    ...
    $.ajax({
    type:'POST',
    url: "/qualityPorc/detailresultquality.html",
    dataType: "json",
    data: { 
        'from':  $('#Desde').val(),
        'until':  $('#Hasta').val(),
